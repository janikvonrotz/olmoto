    ...
    if(options.initpass){
      ...
      Email.send({
        ...
        html: `<h3>Hoi ${user.profile.firstname}</h3>
          ...
          Darauf findest du alle Informationen bezüglich Programm des alljährlichen Treffens der ${Meteor.settings.public.app_name}-Elite 
          ...
          <p>Also, check that shit out und falls noch fragen sind, einfach den Host fragen...</p>
          <p>Peace out and see ya in Börlin!
          </p>`,
      });
    }
